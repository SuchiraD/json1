...
import { Doc, Path, Presence, JSONOp, JSONOpList, Conflict, ConflictType } from './types.js';
export declare const type: {
    ...
    transformPresence: typeof transformPresence;
...
declare function transformPresence(presence: Presence | null, op: JSONOp, isOwnOperation: boolean): Presence | null;
