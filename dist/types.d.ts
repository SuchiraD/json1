...
export declare type JSONOpComponent = {
    /** insert */
    i?: any;
    /** remove */
    r?: any;
...
export declare type JSONOpList = (number | string | JSONOpComponent | JSONOpList)[];
/**
 * A JSON operation.
 *
 ...
 */
export declare type JSONOp = null | JSONOpList;
 ...
 */
export declare type Doc = null | boolean | number | string | Doc[] | {
    [k: string]: Doc;
};
