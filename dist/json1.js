...
function transformPosition(path, op) {
    ...
    const handleDrop = () => {
        ...
        if (pickedAtSlot != null) {
            i = pickIndex;
            if (!RELEASE_MODE)
                log('path', path, 'pi', pickIndex, 'r', r.getPath());
...
function transformPresence(presence, op, isOwnOperation) {
    ...
    if (start && end) {
        return Object.assign(Object.assign({}, presence), { start, end });
    }
    else if (start) {
        return Object.assign(Object.assign({}, presence), { start, end: start });
    }
    else if (end) {
        return Object.assign(Object.assign({}, presence), { start: end, end });
    }
    return null;
}
// ****** Compose
